...
static uint16_t qe_value16[] = {0x5A59,0xE408,0x2A86,0x8F9E,0x11E9,0x7CBC,0x4398,0x1842};
...
const attribute_t qe_ble_profile[QE_ATTRIBUTE_HANDLE_PROFILE_END] =
{
	...
	[17] =
	{
		...
		.value = (uint8_t []){0x08,0x12,0x00,0x20,0xEE,0x8D,0x0C,0xE1,0xF0,0x4A,0x0C,0xB3,0x25,0xDC,0x53,0x6A,0x68,0x86,0x2D},
		.notify_write = 1,
		.notify_read = 1
	},
	...
	[18] =
	{
		...
		.value_length = 0x20,
		.uuid = (uint8_t []){0x20,0xEE,0x8D,0x0C,0xE1,0xF0,0x4A,0x0C,0xB3,0x25,0xDC,0x53,0x6A,0x68,0x86,0x2D},
		.value = (uint8_t []){0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
		.notify_write = 1,
		.notify_read = 1
	},
	...
	[19] =
	{
		...
		.value = (uint8_t []){0x52,0x65,0x71,0x75,0x65,0x73,0x74,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
		.notify_write = 1,
		.notify_read = 1
	},
	...
	[20] =
	{
		...
		.value = (uint8_t []){0x12,0x15,0x00,0x22,0xEE,0x8D,0x0C,0xE1,0xF0,0x4A,0x0C,0xB3,0x25,0xDC,0x53,0x6A,0x68,0x86,0x2D},
		.notify_write = 1,
		.notify_read = 1
	},
	...
	[21] =
	{
		...
		.uuid_length = QE_BLE_PROFILE_UUID_SIZE_CUSTOM,
		.value_length = 0x65,
		.uuid = (uint8_t []){0x22,0xEE,0x8D,0x0C,0xE1,0xF0,0x4A,0x0C,0xB3,0x25,0xDC,0x53,0x6A,0x68,0x86,0x2D},
		.value = (uint8_t []){0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
		.notify_write = 1,
		.notify_read = 1
	},
	// Descriptor: Client Characteristic Configuration
	...
	[23] =
	{
		...
		.value = (uint8_t []){0x52,0x65,0x73,0x70,0x6F,0x6E,0x73,0x65,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
		.notify_write = 1,
		.notify_read = 1
	}

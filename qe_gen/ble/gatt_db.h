...
typedef enum
{
    ...
    BLE_SENSS_DECL_HDL = 0x0010,
    BLE_SENSS_TEMP_DECL_HDL = 0x0011,
    BLE_SENSS_TEMP_VAL_HDL = 0x0012,
    BLE_SENSS_TEMP_CHAR_USER_DESC_DESC_HDL = 0x0013,
    BLE_SENSS_HUMID_DECL_HDL = 0x0014,
    BLE_SENSS_HUMID_VAL_HDL = 0x0015,
    BLE_SENSS_HUMID_CHAR_USER_DESC_DESC_HDL = 0x0016,
    BLE_EVKTEMPCTRLS_DECL_HDL = 0x0017,
    BLE_EVKTEMPCTRLS_TEMPCTRL_DECL_HDL = 0x0018,
    BLE_EVKTEMPCTRLS_TEMPCTRL_VAL_HDL = 0x0019,
    BLE_RTCS_DECL_HDL = 0x001A,
    BLE_RTCS_TIME_DECL_HDL = 0x001B,
    BLE_RTCS_TIME_VAL_HDL = 0x001C,
    BLE_RTCS_TIME_CHAR_USER_DESC_DESC_HDL = 0x001D,
} e_ble_attr_hdl_t;
...
#define BLE_SENSS_TEMP_LEN (2)
#define BLE_SENSS_TEMP_CHAR_USER_DESC_LEN (100)
#define BLE_SENSS_HUMID_LEN (2)
#define BLE_SENSS_HUMID_CHAR_USER_DESC_LEN (100)
#define BLE_EVKTEMPCTRLS_TEMPCTRL_LEN (1)
#define BLE_RTCS_TIME_LEN (2)
#define BLE_RTCS_TIME_CHAR_USER_DESC_LEN (100)
